...
public class ShadowPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = DefaultMod.makeID("ShadowPower");
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("shadow84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("shadow32.png"));

    public ShadowPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new ShadowPower(owner, source, amount);
    }
}
