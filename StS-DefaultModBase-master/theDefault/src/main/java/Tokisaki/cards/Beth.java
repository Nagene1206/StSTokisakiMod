...
public class Beth extends CustomCard {
    ...
    public static final String ID = DefaultMod.makeID(Beth.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("Beth.png");
