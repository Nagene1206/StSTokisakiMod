...
public class Yod extends CustomCard {
    ...
    public static final String ID = DefaultMod.makeID(Yod.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String UPGRADE_DESCRIPTION = cardStrings.UPGRADE_DESCRIPTION;

    public static final String IMG = makeCardPath("Yod.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new DamageAction(m,
                new DamageInfo(p, AbstractDungeon.player.maxHealth-AbstractDungeon.player.currentHealth, damageTypeForTurn),
