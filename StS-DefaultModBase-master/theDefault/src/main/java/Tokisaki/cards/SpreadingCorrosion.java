...
public class SpreadingCorrosion extends CustomCard {
    ...
    public static final String ID = DefaultMod.makeID(SpreadingCorrosion.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("SpreadingCorrosion.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        {
            m.getPower(CorrosionPower.POWER_ID).amount *= magicNumber;
        }
    }
