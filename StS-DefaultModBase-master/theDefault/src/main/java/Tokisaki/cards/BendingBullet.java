...
public class BendingBullet extends CustomCard {
    ...
    public static final String ID = DefaultMod.makeID(BendingBullet.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("BendingBullet.png");
