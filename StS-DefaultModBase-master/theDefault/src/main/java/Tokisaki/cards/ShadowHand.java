...
public class ShadowHand extends CustomCard {
    ...
    public static final String ID = DefaultMod.makeID(ShadowHand.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("ShadowHand.png");
    ...
    public boolean canUse(AbstractPlayer p, AbstractMonster m) {
        ...
        {
            if(!upgraded && AbstractDungeon.player.getPower(ShadowPower.POWER_ID).amount>1)
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if(!upgraded) AbstractDungeon.player.getPower(ShadowPower.POWER_ID).amount -= 2;
        else AbstractDungeon.player.getPower(ShadowPower.POWER_ID).amount -= 1;
