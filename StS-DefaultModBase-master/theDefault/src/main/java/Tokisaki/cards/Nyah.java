...
public class Nyah extends CustomCard {
    ...
    public static final String ID = DefaultMod.makeID(Nyah.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("Nyah.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if(!upgraded) AbstractDungeon.actionManager.addToBottom(new DamageAction(m, new DamageInfo(p, 5, DamageInfo.DamageType.HP_LOSS), AbstractGameAction.AttackEffect.SLASH_HORIZONTAL));
        else AbstractDungeon.actionManager.addToBottom(new DamageAction(m, new DamageInfo(p, 10, DamageInfo.DamageType.HP_LOSS), AbstractGameAction.AttackEffect.SLASH_HORIZONTAL));
