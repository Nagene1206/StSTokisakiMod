...
public class He extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(He.class.getSimpleName());
    public static final String IMG = makeCardPath("He.png");
