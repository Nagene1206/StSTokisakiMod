...
public class Psycho extends CustomCard {
    ...
    public static final String ID = DefaultMod.makeID(Psycho.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("Psycho.png");
    ...
    private static final int UPGRADE_BLCOK = 5;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new PsychoAction(this.uuid));
    }
