...
public class Rampage extends CustomCard {
    ...
    public static final String ID = DefaultMod.makeID(Rampage.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("Rampage.png");
    ...
    public void upgrade() {
        if (!upgraded) {
            upgradeName();
            upgradeMagicNumber(UPGRADE_NUMBER);
