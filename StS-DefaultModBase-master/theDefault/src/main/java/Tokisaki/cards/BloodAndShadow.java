...
public class BloodAndShadow extends CustomCard {
    ...
    public static final String ID = DefaultMod.makeID(BloodAndShadow.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("BloodAndShadow.png");
