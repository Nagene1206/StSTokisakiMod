...
public class Zain extends CustomCard {
    ...
    public static final String ID = DefaultMod.makeID(Zain.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("Zain.png");
