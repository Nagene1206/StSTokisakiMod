...
public class Mozambique extends CustomCard {
    ...
    public static final String ID = DefaultMod.makeID(Mozambique.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("Mozambique.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new DamageAction(m, new DamageInfo(p, damage, damageTypeForTurn), AbstractGameAction.AttackEffect.BLUNT_HEAVY));
        AbstractDungeon.actionManager.addToBottom(new GunShotAction());
        AbstractDungeon.actionManager.addToBottom(new DamageAction(m, new DamageInfo(p, damage+8, damageTypeForTurn), AbstractGameAction.AttackEffect.BLUNT_HEAVY));
    }
