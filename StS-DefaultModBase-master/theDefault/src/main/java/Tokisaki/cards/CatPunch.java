...
public class CatPunch extends CustomCard {
    ...
    public static final String ID = DefaultMod.makeID(CatPunch.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String UPGRADE_DESCRIPTION = cardStrings.UPGRADE_DESCRIPTION;

    public static final String IMG = makeCardPath("CatPunch.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        {
            int cnt = p.getPower(CatPower.POWER_ID).amount;
            for(int i=0;i<cnt;i++)
            {
