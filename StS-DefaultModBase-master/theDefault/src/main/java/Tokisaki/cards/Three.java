...
import Tokisaki.actions.PsychoAction;
...
public class Three extends CustomCard {
    ...
    public static final String ID = DefaultMod.makeID(Three.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("Three.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if(upgraded) AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p,p, new ShadowPower(p, p, 3),3));
    }
