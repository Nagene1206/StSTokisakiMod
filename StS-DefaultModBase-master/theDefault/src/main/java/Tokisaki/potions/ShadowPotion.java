...
public class ShadowPotion extends CustomPotion {

    public static final String POTION_ID = Tokisaki.DefaultMod.makeID("ShadowPotion");
    ...
    public ShadowPotion() {
       ...
       // Do you throw this potion at an enemy or do you just consume it.
        ...
        if(Settings.language == Settings.GameLanguage.ZHS)
            tips.add(new PowerTip("阴影","你可以使用阴影来使用特定的卡片。"));
        else if(Settings.language == Settings.GameLanguage.KOR)
            tips.add(new PowerTip("그림자","그림자를 사용하여 특정 카드를 사용할 수 있습니다."));
        else
            tips.add(new PowerTip("shadow","You can use a particular card using a shadow."));
    }
    ...
    public void use(AbstractCreature target) {
        ...
        if (AbstractDungeon.getCurrRoom().phase == AbstractRoom.RoomPhase.COMBAT) {
            AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(target, AbstractDungeon.player, new ShadowPower(target,target,potency), potency));
        }
    }
